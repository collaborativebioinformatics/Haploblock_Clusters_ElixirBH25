...
export INPUT_FASTA=$BASE_DIR/data/TNF/data/CHB/haploblock_phased_seq_TNFa/haploblock_phased_seq_merged/chr6_region_31480875-31598421.fa
export RESULTS=TNF_CHB_chr6_region_31480875-31598421
export TEMP_FOLDER=$EPHEMERAL/BioHack2025_tempfiles
export MIN_SEQ_ID=0.999
